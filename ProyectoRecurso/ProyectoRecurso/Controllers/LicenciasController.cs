...
namespace ProyectoRecurso.Controllers
{
    public class LicenciasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,IdEmpleado,Desde,Hasta,Comentario")] Licencias licencias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,IdEmpleado,Desde,Hasta,Comentario")] Licencias licencias)
        {
            if (ModelState.IsValid)
            {
